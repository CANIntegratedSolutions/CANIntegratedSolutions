...
export default function HomePage() {
    return (
        <div className="w-full flex flex-col items-center">
            ...
            {/* 1. HERO SECTION */}
            <section className="relative w-full min-h-[500px] md:h-[550px] bg-can-dark-green flex flex-col md:flex-row overflow-hidden">
                ...
                {/* Left Content Area (Shifted up with snit 3-line heading break & tight margins) */}
                <div className="relative z-10 w-full md:w-1/2 px-8 py-10 md:py-12 md:pl-24 flex flex-col justify-center h-full">
                    <h1 className="text-5xl md:text-7xl font-black text-can-white leading-[1.1] tracking-tight mb-4">
                        CAN<br />
                        Integrated<br />
                        Solutions Ltd
                    </h1>
                    <p className="text-can-white/90 text-base md:text-lg font-medium leading-relaxed max-w-lg mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Link href="/about" className="bg-can-lime-green text-can-dark-green text-center font-bold px-8 py-3.5 rounded-lg shadow-soft hover:bg-white transition-colors text-sm">
                            Discover More
                        </Link>
                        <Link href="/services" className="bg-transparent border-2 border-can-lime-green text-can-lime-green text-center font-bold px-8 py-3.5 rounded-lg hover:bg-can-lime-green hover:text-can-dark-green transition-colors text-sm">
                            Our Services
                        </Link>
                    </div>
                </div>
                ...
                <div className="relative z-10 w-full md:w-1/2 h-[350px] md:h-full bg-can-white md:[clip-path:polygon(15%_0,100%_0,100%_100%,0%_100%)] flex items-center justify-center p-6 md:pl-[12%]">
                    <div className="grid grid-cols-2 grid-rows-2 gap-4 w-full max-w-[380px] md:max-w-[420px] aspect-square transform md:-translate-y-4">
            ...
            <section className="w-full max-w-7xl mx-auto px-8 py-24 flex flex-col lg:flex-row gap-16 relative z-10">
                ...
                <div className="w-full lg:w-3/5 flex flex-col justify-center">
                    ...
                    <p className="text-base text-can-text-dark leading-relaxed mb-6 font-medium text-justify">
                        ...
                        structures, modern agricultural innovations, project management, and facility maintenance, and comprehensive cleaning services, to equipment
            ...
            <section className="w-full max-w-7xl mx-auto px-8 py-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Link href="/services" className="bg-can-white rounded-2xl p-8 border border-gray-100 shadow-soft hover:shadow-strong hover:border-can-lime-green transition-all group flex flex-col items-start">
                        ...
                        <p className="text-sm font-medium text-can-text-dark mb-6">Comprehensive home cleaning, commercial, industrial, and post-construction cleaning solutions.</p>
                        <span className="mt-auto text-can-lime-green font-bold text-sm flex items-center gap-2 group-hover:gap-4 transition-all">Explore <i className="fa-solid fa-chevron-right text-xs"></i></span>
                    </Link>
